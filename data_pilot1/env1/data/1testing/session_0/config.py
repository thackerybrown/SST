...
#initialPos = Point3(-32,-4,0.5)#for movie
initialHead = [-90.0]
...
laterPos = [Point3(-41,32,0.5)]#,Point3(-41,-5,0.5)]#Env 1 avatar reposition locs

#laterPos = [Point3(-5,-31,0.5),Point3(-41,-5,0.5)]#Env 2 avatar reposition locs
laterHead = [-90.0]
...
shopLocs = [[31,23,90],[-23,-13,90],[-32,14,90]]
shopZ    = 0.1
...
#environment 1
storeLocs = [[22,14,90],[-14,-13,90],[-5,23,90]] # [x, y, orientation]

#environment 2
#storeLocs = [[-32,-22,90],[-50,7,90],[22,15,90]]
...
buildingLocs = [[-50,50],[-50,41],[-50,32],[-32,41],[-32,32],[-23,41],[-23,32], # [x, y] bldg1
                [-50,14],[-50,5],[-32,5],[-23,14],[-23,5],#bldg2 #[-32,14],
                [-50,-13],[-41,-13],[-32,-13],[-23,-22],[-23,-31],#bldg3 #[-23,-13],
                [-5,5],[-5,-4],[-5,-13],[-5,-31], [4,-31],#bldg4
                [13,-31],[22,-31],[31,-31],[31,-22],[31,-13],[31,-4],[31,5],#bldg5
                [-5,50],[-5,41],[-5,32],[13,32],[4,50],[13,50],[22,50],#bldg6
                [31,50],[31,41],[31,32],[31,14],[-5,14],[4,14],[13,14]]#bldg7 #[31,23],
