...
#laterPos = [Point3(-41,14,0.5),Point3(-41,-5,0.5)]#Env 1 avatar reposition locs

laterPos = [Point3(13,-22,0.5)]#,Point3(-41,-5,0.5)]#Env 2 avatar reposition locs
laterHead = [0.0]

# Instructions.
instructSize    = 0.1#0.075
...
instructFgColor = Point4(1,1,0,1) #Point4(1, 1, 1, 1)
instructMargin  = 0.06
...
shopLocs = [[-5,41,0],[4,5,90],[31,-13,90]]
shopZ    = 0.1
...
#environment 1
##storeLocs = [[22,14,90],[-5,23,90],[-14,-13,90]] # [x, y, orientation]

#environment 2
storeLocs = [[-32,-24,90],[-52,6,90],[23,15,90]]
...
buildingLocs = [[-50,50],[-50,41],[-50,32],[-50,23],[-50,14],[-41,50],[-32,50], # [x, y] bldg1
                ...
                [-14,41],[4,41],[4,32],[4,23],#bldg3 #[-5,41],
                [13,5],[4,-4],[4,-13], [13,-4], [13,-13], [-5,-13], [-5,-22],#bldg4 #[4,5],
                [-14,-13],[-23,-13],[-32,-13],[-32,-4],[-41,-4],#bldg5
                [-50,-22],[-50,-31],[-41,-31],[-32,-31],[-23,-31],#bldg6
                [22,50],[22,41],[22,32],[22,23],[31,23],#bldg 7
                [31,14],[31,5],[31,-4],[31,-22], [31,-31]]#bldg 8 #[31,-13],
...
###environment 5
##buildingLocs = [[-50,41],[-41,41],[-32,41],[-23,41],[-14,50],[-14,41],[-14,32], # [x, y] bldg1
##                [-41,23],[-41,14],[-41,5],[-41,-13],[-32,23],[-32,14],[-32,5],[-32,-13],#bldg2
##                [-50,-31],[-41,-31],[-32,-31],[-23,-31],[-14,-31],[-5,-31],[-14,-4],[-5,-4],#bldg3
##                [4,-31],[13,-31],[22,-31],[31,-31],[13,-4],[13,-13],[22,-13],#bldg4
##                [-14,14],[-5,14],[4,14],[13,14],[4,23],[4,32],#bldg5
##                [31,5],[31,14],[31,23],[31,32],[31,41],#bldg6
##                [-5,50],[4,50],[13,50],[22,50],[31,50]]#bldg 7
...
##barrier1Locs = [[-5,28],[-5,-17],[13,36],[13,28],[9,32],[17,32],[17,14]]
##numBarriers1 = len(barrier1Locs)
###20-unit barriers
##barrier2Locs = [[-27.5,45],[-27.5,28],[-27.5,18],[-27.5,1],[8.5,10],[17.5,0],[-46,45.5],[-36,36.5],[-19,36.5],[-36,9.5],[-19,9.5],[-19,-17.5],[-1,36.5]]
##numBarriers2 = len(barrier2Locs)
###etc..
##barrier3Locs = [[-32,-9],[-5,-27],[4,18],[13,46],[-9,41],[-1,-4],[9,-13]]
##numBarriers3 = len(barrier3Locs)
##
##barrier4Locs = [[-27.5,55],[-9,0.5]]
##numBarriers4 = len(barrier4Locs)
##
##barrier5Locs = [[-46,14],[27,23]]
##numBarriers5 = len(barrier5Locs)

#10-unit barriers (1 building size)
barrier1Locs = [[-32,37],[-41,28],[-32,18],[-50,10],[-50,-18],[-41,-8],[-5,-26],[-14,1],[4,19],[22,19],[-18,41],[-36,32],[-36,14],[-27,23],[-18,5],[-27,-4],[-45,-4],[-46,-22],[-36,-13],[-19,-31],[9,-31],[-9,-22],[-1,-22]]
numBarriers1 = len(barrier1Locs)
#20-unit barriers
barrier2Locs = [[-8.5,37],[-18.5,27],[-27.5,10],[-36.5,0],[8.5,9],[8.5,-17],[18,-27],[0,28],[-28,45.5],[0,0.5],[-46,19]]
numBarriers2 = len(barrier2Locs)
#etc..
barrier3Locs = [[-5,45],[-14,-9],[-33,-27],[-21,-17],[-5,-35],[-10,14],[8,32],[17,-4],[-55,-4]]
numBarriers3 = len(barrier3Locs)

barrier4Locs = [[18,36.5]]
numBarriers4 = len(barrier4Locs)
...
#terrainModel1  = '../models/building_blox/arena1_11x11.egg'
...
experimentCompleteText = 'You have completed the quests in this town.'
