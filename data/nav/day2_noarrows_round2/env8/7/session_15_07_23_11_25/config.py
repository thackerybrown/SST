...
initialPos = Point3(48,52,0.8)#for training

#start pos for future envs
newstartPos = [Point3(4,8,0.8),Point3(40,52,0.8),Point3(40,52,0.8),Point3(24,4,0.8)]

initialHead = [[270.0],[180.0],[270.0],[270.0],[90.0]]
...
custLocs = [[44,52,270]]#location of custom goal for, e.g., training
