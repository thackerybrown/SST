...
initialPos = Point3(52,48,0.8)#for training
...
initialHead = [[0.0],[0.0],[0.0],[90.0],[180.0],[180.0],[270.0],[90.0],[180.0],[270.0],[270.0],[90.0]]
...
custLocs = [[52,44,0]]#location of custom goal for, e.g., training
