...
initialPos = Point3(40,4,0.8)#for training
...
initialHead = [[270.0],[0.0],[0.0],[90.0],[180.0],[180.0],[270.0],[90.0],[180.0],[270.0],[270.0],[90.0]]
...
custLocs = [[36,4,270]]#location of custom goal for, e.g., training
