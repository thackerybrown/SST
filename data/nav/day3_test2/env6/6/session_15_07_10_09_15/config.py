...
initialPos = Point3(22,18,0.8)#for movie

#start pos for future envs
newstartPos = [Point3(4,26,0.8),Point3(4,26,0.8),Point3(52,18,0.8),Point3(50,14,0.8),Point3(34,4,0.8),Point3(36,52,0.8)]

initialHead = [[90.0],[90.0],[90.0],[270.0],[270.0],[180.0],[0.0]]
...
#environment 1
storeLocs5 = [[4,34,90],[26,52,90],[20,22,90]] # [x, y, orientation]
#environment 2
...
#environment 6
storeLocs = [[52,30,90],[42,6,90],[42,44,90]]
#environment 7
...
terrainModel5  = '../../models/SST_towns/town1_v1.egg'
...
terrainModel  = '../../models/SST_towns/town6_v1.egg'
