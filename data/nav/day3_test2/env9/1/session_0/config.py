...
initialPos = Point3(36,18,0.8)#for movie

#start pos for future envs
newstartPos = [Point3(50,14,0.8),Point3(34,4,0.8),Point3(36,52,0.8)]

initialHead = [[270.0],[270.0],[180.0],[0.0]]
...
#environment 1
storeLocs8 = [[4,34,90],[26,52,90],[20,22,90]] # [x, y, orientation]
#environment 2
...
#environment 9
storeLocs = [[4,18,90],[20,6,90],[28,46,90]]
#environment 10
...
terrainModel8  = '../../models/SST_towns/town1_v1.egg'
...
terrainModel  = '../../models/SST_towns/town9_v1.egg'
