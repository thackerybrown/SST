...
initialPos = Point3(20,12,0.8)#for movie

#start pos for future envs
newstartPos = [Point3(36,14,0.8),Point3(52,30,0.8),Point3(20,28,0.8),Point3(4,26,0.8),Point3(4,26,0.8),Point3(52,18,0.8),Point3(50,14,0.8),Point3(34,4,0.8),Point3(36,52,0.8)]

initialHead = [[270.0],[90.0],[270.0],[90.0],[90.0],[90.0],[270.0],[270.0],[180.0],[0.0]]
...
#environment 1
storeLocs2 = [[4,34,90],[26,52,90],[20,22,90]] # [x, y, orientation]
#environment 2
storeLocs1 = [[44,42,90],[20,4,90],[32,50,90]]
#environment 3
storeLocs = [[50,50,90],[4,46,90],[44,28,90]]
#environment 4
...
terrainModel2  = '../../models/SST_towns/town1_v1.egg'
terrainModel1  = '../../models/SST_towns/town2_v1.egg'
terrainModel  = '../../models/SST_towns/town3_v1.egg'
