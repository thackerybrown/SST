...
initialPos = Point3(36,8,0.8)#for training

#start pos for future envs
newstartPos = [Point3(44,24,0.8), Point3(20,16,0.8),Point3(16,44,0.8),Point3(36,0,0.8),Point3(28,0,0.8),Point3(32,-4,0.8),Point3(40,4,0.8),Point3(4,8,0.8),Point3(40,52,0.8),Point3(40,52,0.8),Point3(24,4,0.8)]

initialHead = [[180.0],[0.0],[0.0],[90.0],[180.0],[180.0],[270.0],[90.0],[180.0],[270.0],[270.0],[90.0]]
...
#environment 1
storeLocs = [[4,34,90],[26,52,90],[20,22,90]] # [x, y, orientation]
#environment 2
storeLocs1 = [[44,42,90],[20,4,90],[32,50,90]]
#environment 3
storeLocs2 = [[50,50,90],[4,46,90],[44,28,90]]
#environment 4
storeLocs3 = [[22,44,90],[52,34,90],[12,22,90]]
#environment 5
storeLocs4 = [[4,26,90],[36,6,90],[26,38,90]]
#environment 6
...
custLocs = [[36,12,180]]#location of custom goal for, e.g., training
custLocs1 = [[44,20,0]]#location of custom goal for, e.g., training
custLocs2 = [[20,12,0]]#location of custom goal for, e.g., training
custLocs3 = [[20,44,90]]#location of custom goal for, e.g., training
custLocs4 = [[36,4,180]]#location of custom goal for, e.g., training
...
terrainModel  = '../../models/SST_towns/town1_v1.egg'
terrainModel1  = '../models/SST_towns/town2_v1.egg'
terrainModel2  = '../models/SST_towns/town3_v1.egg'
terrainModel3  = '../models/SST_towns/town4_v1.egg'
terrainModel4  = '../models/SST_towns/town5_v1.egg'
