...
initialPos = Point3(36,0,0.8)#for training
...
initialHead = [[180.0],[180.0],[270.0],[90.0],[180.0],[270.0],[270.0],[90.0]]
...
custLocs = [[36,4,180]]#location of custom goal for, e.g., training
