...
initialPos = Point3(4,16,0.8)#for training

#start pos for future envs
newstartPos = [Point3(40,4,0.8),Point3(4,8,0.8),Point3(40,52,0.8),Point3(40,52,0.8),Point3(24,4,0.8)]

initialHead = [[180.0],[90.0],[180.0],[270.0],[270.0],[90.0]]
...
custLocs = [[4,20,180]]#location of custom goal for, e.g., training
