...
initialPos = Point3(4,18,0.8)#for movie

#start pos for future envs
newstartPos = [Point3(52,18,0.8),Point3(50,14,0.8),Point3(34,4,0.8),Point3(36,52,0.8)]

initialHead = [[180.0],[270.0],[270.0],[180.0],[0.0]]
...
#environment 1
storeLocs7 = [[4,34,90],[26,52,90],[20,22,90]] # [x, y, orientation]
#environment 2
...
#environment 8
storeLocs = [[52,14,90],[36,4,90],[32,52,90]]
#environment 9
...
terrainModel7  = '../../models/SST_towns/town1_v1.egg'
...
terrainModel  = '../../models/SST_towns/town8_v1.egg'
