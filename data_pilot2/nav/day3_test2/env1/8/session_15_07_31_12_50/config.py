...
initialPos = Point3(36,8,0.8)#for movie

#start pos for future envs
newstartPos = [Point3(6,26,0.8), Point3(20,22,0.8),Point3(36,14,0.8),Point3(52,30,0.8),Point3(20,28,0.8),Point3(4,26,0.8),Point3(4,26,0.8),Point3(52,18,0.8),Point3(50,14,0.8),Point3(34,4,0.8),Point3(36,52,0.8)]

initialHead = [[180.0],[90.0],[0.0],[90.0],[270.0],[90.0],[90.0],[90.0],[270.0],[270.0],[180.0],[0.0]]
...
terrainModel6  = '../../models/SST_towns/town7_v2.egg'
...
experimentCompleteText = 'press enter' #'You have successfully completed all of the quests. This ends the experiment.'
